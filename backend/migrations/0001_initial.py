    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('archived', 'Archived')], default='active', max_length=25)),
                ('created_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.profile')),
            ],
        ),
        migrations.CreateModel(
            name='ImportFileLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('archived', 'Archived')], default='active', max_length=25)),
                ('app', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.app')),
                ('child_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='child_profile', to='backend.profile')),
                ('created_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('parent_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_profile', to='backend.profile')),
            ],
        ),
        migrations.CreateModel(
            name='AppUser',
        ...
        migrations.AddIndex(
            model_name='profile',
            index=models.Index(fields=['profile_id'], name='profile_index'),
        ),
        migrations.AddIndex(
            model_name='message',
            index=models.Index(fields=['message_id'], name='message_index'),
        ),
        migrations.AddIndex(
            model_name='connection',
            index=models.Index(fields=['connection_id'], name='connection_index'),
        ),
        migrations.AddIndex(
            model_name='appuser',
