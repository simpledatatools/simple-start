# Generated by Django 4.2.2 on 2024-02-09 19:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('archived', 'Archived')], default='active', max_length=25)),
                ('created_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('dataset', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.dataset')),
            ],
        ),
        migrations.CreateModel(
            name='ImportFileLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_activity', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('active', 'Active'), ('archived', 'Archived')], default='active', max_length=25)),
                ('child_node', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='child_node', to='backend.node')),
                ('created_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('dataset', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.dataset')),
                ('parent_node', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_node', to='backend.node')),
            ],
        ),
        migrations.AddField(
            model_name='dataset',
            name='import_file',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.importfile'),
        ),
        migrations.CreateModel(
            name='AppUser',
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['sna_id'], name='sna_index')],
            },
        ),
        migrations.AddIndex(
            model_name='node',
            index=models.Index(fields=['node_id'], name='node_index'),
        ),
        migrations.AddIndex(
            model_name='edge',
            index=models.Index(fields=['edge_id'], name='edge_index'),
        ),
        migrations.AddIndex(
            model_name='dataset',
            index=models.Index(fields=['dataset_id'], name='dataset_index'),
        ),
        migrations.AddIndex(
            model_name='appuser',
            index=models.Index(fields=['app_user_id'], name='app_user_index'),
        ),
        migrations.AddIndex(
            model_name='app',
